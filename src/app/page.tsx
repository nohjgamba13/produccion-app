...
function urgencyKey(o: OrderRow) {
  ...
  if (st === "completed") return 999999;
  const d = daysUntil(o.due_date);
  if (d === null) return 500000;
  return d;
}
...
export default function HomePage() {
  ...
  const myStageLabel = useMemo(() => {
    if (!myStage) return "sin asignar";
    if (isStageKey(myStage)) return STAGE_LABEL[myStage];
    return myStage;
  }, [myStage]);
